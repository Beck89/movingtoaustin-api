...
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS garage_spaces numeric;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS parking_total numeric;
...
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS association_fee numeric;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS association_fee_frequency text;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS tax_annual_amount numeric;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS fireplaces_total numeric;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS street_name text;
ALTER TABLE mls.properties ADD COLUMN IF NOT EXISTS bathrooms_total_integer numeric;
